...
CRATES="
	...
	semver-parser-0.7.0
	sentry-0.29.2
	sentry-anyhow-0.29.2
	sentry-backtrace-0.29.2
	sentry-contexts-0.29.2
	sentry-core-0.29.2
	sentry-types-0.29.2
	serde-1.0.152
	...
	symbolic-il2cpp-11.0.0
	symbolic-ppdb-11.0.0
	symbolic-symcache-11.0.0
	syn-1.0.107
	tap-1.0.1
	tempfile-3.3.0
	term-0.7.0
...
SRC_URI="$(cargo_crate_uris) https://github.com/getsentry/sentry-cli/archive/refs/tags/2.12.0.tar.gz"
